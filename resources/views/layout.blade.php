					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i>0773398244</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> dn0102302@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Bài Viết<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="blog-single.html">Chi tiết bài viết</a></li>
                                    </ul>
                                </li> 
